...
public:
	...
	template <typename Return, typename... Args>
	static auto InvokeAddr(void* funcAddress, Args... args) -> Return {
	...
	public:
		...
		struct Camera : Component {
			...
			static auto GetMain() -> Camera* {
				...
				static Class* camClass = Get("UnityEngine.CoreModule.dll")->Get("Camera");
				...
				if (!method) {
					method = camClass->Get<Method>("get_main");
				}
